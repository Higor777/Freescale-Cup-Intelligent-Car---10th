...
//==============================================================
//函数名：float AverFilter_getVal(AverFilter_Type *filter,int32_t current)
//功能描述：平均值滤波
//参数：filter 滤波数据地址 current 当前数据 
//返回：无
//==============================================================
...
//==============================================================
//函数名：float LP1Filter_getVal(LP1Filter_Type *filter,float current,float a)
//功能描述：低通滤波
//参数：filter 之前滤波数据地址 current 当前数据 a 滤波参数
//返回：无
//==============================================================
...
//==============================================================
//函数名：void KalmanFliter(float z_inc, float u_gyro)
//功能描述：卡尔曼滤波融合
//参数：z_inc Z轴加速度信号 u_gyro 陀螺仪信号
//返回：无
//==============================================================
