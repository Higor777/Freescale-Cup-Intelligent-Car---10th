...
//==============================================================
//函数名：void M_Encoder_Scan(void)
//功能描述：鼠标编码器扫描函数，要每1~5ms运行一次,编码器质量好的运行间隔时间可更短，用于调参数
//参数：无
//返回：无
//==============================================================
...
//==============================================================
//函数名：uint8_t Key_STA(void)
//功能描述：返回按键状态，用于实现多按键连按输出
//参数：无
//返回：keysta 按键状态
//==============================================================
